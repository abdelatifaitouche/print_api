...
from app.schemas.company_schema import CompanyRead , CompanyCreate , CompanyUpdate
...
class CompanyService(ServiceInterface):
    ...
    def update(self ,company_id : str ,  data : CompanyUpdate , db : Session) -> CompanyRead :
        ...
        updated_model:CompanyModel = self.__repo.update(company_model , updated_data , db)
