...
class JwtManager : 
    ...
    def __generate_signature(self , encoded_header : str , encoded_payload : str) -> str :
        ...
        signature_raw_bytes = hmac.new(message , self.__secret_key.encode("ascii") , hashlib.sha256).digest()
        
        url_safe_signature = base64.urlsafe_b64encode(signature_raw_bytes).decode("ascii").rstrip("=")
