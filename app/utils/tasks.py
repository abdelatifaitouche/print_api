...
def process_file_upload(self, uploaded_file_id: str, file_name: str, file_path: str):
    ...
    logger.info(f"Params: uploaded_file_id={uploaded_file_id}, file_name={file_name}, file_path={file_path}")
    ...
    try:
        ...
        uploaded_file = db.query(UploadedFileDb).filter(
            UploadedFileDb.id == uploaded_file_id
        ).first()
        ...
        logger.info(f"Found UploadedFile: id={uploaded_file.id}, name={uploaded_file.file_name}, status={uploaded_file.status}")
